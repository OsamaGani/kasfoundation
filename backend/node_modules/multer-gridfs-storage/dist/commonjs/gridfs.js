...
const isFileGeneratorFunction = (value) => is_generator_1.default.fn(value);
const isFileGenerator = (value) => (0, is_generator_1.default)(value);
/**
...
class GridFsStorage extends node_events_1.EventEmitter {
    static cache = new cache_js_1.Cache();
    ...
    static _randomBytes = (0, node_util_1.promisify)(node_crypto_1.default.randomBytes);
    db = null;
    configuration;
    connecting = false;
    caching = false;
    ...
    async _openConnection(url, options) {
        const client = await mongodb_1.MongoClient.connect(url, options);
    ...
    async fromMulterStream(readStream, request, file) {
        ...
        return new Promise((resolve, reject) => {
            ...
            const settleOnce = (0, utils_js_1.createOnceGuard)();
            const emitError = (streamError) => {
                settleOnce(() => {
                    ...
                    (0, utils_js_1.abortIncompleteUpload)(writeStream);
            ...
            (0, pump_1.default)([readStream, ...transforms, writeStream], (pumpError) => {
                if (pumpError) {
                    emitError(pumpError);
                }
            });
    ...
    _connect() {
        ...
        if (db && !(0, utils_js_1.isPromise)(db)) {
            this._setDb(db);
            return;
        }
    ...
    _setDb(db) {
        ...
        this.db = (0, utils_js_1.getDatabase)(db);
