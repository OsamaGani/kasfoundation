...
import { GridFile, ConnectionResult, UrlStorageOptions, DbStorageOptions } from './types/index.js';
/**
...
export declare class GridFsStorage extends EventEmitter implements StorageEngine {
    static cache: Cache;
    private static readonly _randomBytes;
    db: Db | null;
    ...
    private _clientEventSource;
    private readonly _emitDbError;
