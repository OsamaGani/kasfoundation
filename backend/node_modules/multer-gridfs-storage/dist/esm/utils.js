 ...
 */
export function abortIncompleteUpload(writeStream) {
 ...
 * or buffers
 */
export function compareBy(object1, object2) {
...
export function compareUris(uri1, uri2) {
    ...
    const sortPairs = (params) => [...params].sort(([k1, v1], [k2, v2]) => k1.localeCompare(k2) || v1.localeCompare(v2));
 ...
 */
export function getDatabase(obj) {
