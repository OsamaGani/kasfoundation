          ...
          <div className="member-hero-content">
            ...
            <div className="member-profile">
              <div className="member-image-box">
                <img
                  src="https://placehold.co/800x1000/e9ebf5/0637a5?text=Hamad"
                  alt="Hamad"
                />
              </div>
              ...
              <div className="member-details">
                ...
                <p>
                  Hamad is a young goalkeeper developing his football abilities
                  through the foundation's training programme.
                </p>

                <p>
                  Regular coaching helps young players build technical skills,
                  confidence, teamwork, and a strong sporting mindset.
                </p>
