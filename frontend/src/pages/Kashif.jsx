          ...
          <div className="member-hero-content">
            ...
            <div className="member-profile">
              <div className="member-image-box">
                <img
                  src="https://placehold.co/800x1000/e9ebf5/0637a5?text=Kashif"
                  alt="Kashif"
                />
              </div>
              ...
              <div className="member-details">
                ...
                <p>
                  Kashif is part of the football programme at The Grassroots
                  Foundation, developing his abilities through structured
                  training.
                </p>

                <p>
                  The programme gives young players opportunities to improve
                  their technique, teamwork, discipline, and confidence.
                </p>
