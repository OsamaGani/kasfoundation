          ...
          <div className="member-hero-content">
            ...
            <div className="member-profile">
              <div className="member-image-box">
                <img
                  src="https://placehold.co/800x1000/e9ebf5/0637a5?text=Rehan"
                  alt="Rehan"
                />
              </div>
              ...
              <div className="member-details">
                ...
                <p>
                  Rehan is part of the football development programme at The
                  Grassroots Foundation.
                </p>

                <p>
                  The programme supports players as they improve their technical
                  abilities, decision-making, teamwork, and overall confidence
                  on the field.
                </p>
