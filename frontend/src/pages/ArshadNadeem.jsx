...
import "./ArshadNadeem.css";

function ArshadNadeem() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
          ...
          <div className="member-hero-content">
            ...
            <div className="member-profile">
              <div className="member-image-box">
                <img
                  src="https://placehold.co/800x1000/e9ebf5/0637a5?text=Arshad+Nadeem"
                  alt="Arshad Nadeem"
                />
              </div>
              ...
              <div className="member-details">
                ...
                <p>
                  Arshad Nadeem contributes to the coaching environment at The
                  Grassroots Foundation, helping young players develop their
                  football abilities.
                </p>

                <p>
                  Through structured training and guidance, the coaching team
                  encourages discipline, teamwork, confidence, and continuous
                  improvement.
                </p>
